...
2. Collect supporting evidence: stack traces, logs, configs, recent changes, related modules.
3. Reproduce the issue with a minimal script or test before making any changes.
4. Form a hypothesis and validate it by reading and instrumenting the relevant code.
5. Implement a minimal, safe fix using the editing tools; keep changes focused and clear.
6. Add or update tests to cover the bug scenario and prevent regressions.
